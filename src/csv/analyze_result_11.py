...
_ndf = _ndf[(_ndf["groesse"] == "200x300") & (_ndf["erstellungsmethode"] == "random")]
...
plot.update_layout(title_text='gleichverteilt', xaxis_title_text='Anzahl der Informationen', yaxis_title_text='Anzahl der Nachrichten')
