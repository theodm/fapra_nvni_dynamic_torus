...
_ndf = _ndf[(_ndf["groesse"] == "200x300") & (_ndf["erstellungsmethode"] == "random_normal") & (_ndf["gesuchte_information"] == "normal_selten")]
...
plot.update_layout(title_text='normalverteilt, häufige Information', xaxis_title_text='Anzahl der Informationen', yaxis_title_text='Anzahl der Nachrichten')
