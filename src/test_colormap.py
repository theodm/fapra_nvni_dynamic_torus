...
def test_colormap_for_information_10_default_inferno():
    ...
    assert colormap_for_information(10) == ['#000004', '#1a0a4a', '#3b0f40', '#5c1436', '#7d1a2c', '#9e1f22', '#bf2408',
                                            '#e02a00', '#ff6e00', '#ffab00']
...
def test_colormap_for_information_10_default_viridis():
    ...
    assert colormap_for_information(10, color_map='viridis') == ['#440154', '#482475', '#414487', '#355f8d', '#2a788e', '#21918c', '#22a884', '#44bf70', '#7ad151', '#bddf26']
